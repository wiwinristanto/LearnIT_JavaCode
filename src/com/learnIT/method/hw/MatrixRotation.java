...
public class MatrixRotation {
   ...
   public static void main(String[] args) {
	...
	private static boolean rotateMatrix(double[][] matrix, int mode) {
		...
		switch (mode) {
		case 1:
			System.out.println("90 degrees rotate:" + System.lineSeparator());
			rotate90(matrix);
			break;
		case 2:
			System.out.println("180 degrees rotate:" + System.lineSeparator());
			rotate180(matrix);
			break;
		case 3:
			System.out.println("270 degrees rotate:" +System.lineSeparator());
			rotate270(matrix);
			break;
		default:
